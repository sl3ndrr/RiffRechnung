...
export function seedState(state: AppState, storage: Storage = localStorage): StorageEnvelope {
  ...
  const envelope: StorageEnvelope = { app: 'riffrechnung', storageVersion: 4, schemaVersion: 8, datasetId: crypto.randomUUID(), commitId: crypto.randomUUID(), revision: 1, savedAt: '2026-09-06T12:00:00.000Z', operation: 'edit', ancestors: [], source: null, data: structuredClone(state) }
