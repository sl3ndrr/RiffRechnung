...
Lokal: Node 24.19.0 statt 22.x; `npm ci` scheitert mit HTTP 403 für `yocto-queue`. Ohne installierte Projektabhängigkeiten sind Lint, Fachtests, Typecheck, Build und Browserlauf lokal nicht ausführbar. CI-Ergebnisse des neuen Head-Commits sind gesondert nachzutragen; die AP1-Nachweise unten gelten nur für den alten Stand.
