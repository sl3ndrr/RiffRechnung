...
function upgradeToV8(value: AppState, report: MigrationReport): AppState {
  const state = structuredClone(value)
  state.schemaVersion = 8
  report.changes.push({ path: 'schemaVersion', before: 7, after: 8, reason: 'Optionale Kontaktnamen und Rechnungsart; Altanzeigenamen und historische Belege bleiben unverändert, ohne rückwirkende Aufteilung oder Ergänzung.' })
  return state
}
