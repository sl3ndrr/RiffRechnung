        ...
        <div className="settings-content" >
          ...
          <section id="backup" className="surface settings-section settings-section--backup">
            ...
            <div className="backup-grid">
              <article><span className="backup-icon"><Download aria-hidden="true" /></span><h3>Manuelles Backup</h3><p>Eine Klartext-JSON-Datei mit Familien, Rechnungen, Einstellungen, Notizen, Belegversionen und Änderungsverlauf.</p><button className="button button--tonal" onClick={onExport}><Download aria-hidden="true" /> JSON exportieren</button></article>
