      ...
      <div className="settings-layout">
        ...
        <div className="settings-content" >
          ...
          <section id="numbering" className="surface settings-section">
            <div className="settings-section__heading"><span><FileJson aria-hidden="true" /></span><div><h2>Rechnungsvorgaben</h2><p>Jede lernende Person bzw. Kombination von Lernenden hat einen eigenen fortlaufenden Nummernkreis.</p></div></div>
            <div className="form-grid form-grid--3">
              <label className="field field--wide"><span>Nummernmuster</span><input className="mono" value={form.numberPattern} onChange={(event) => setForm({ ...form, numberPattern: event.target.value })} /><small>Platzhalter: {'{YYYY}'}, {'{YY}'}, {'{K}'} für Lernende und {'{NNNN}'}</small></label>
              <div className="number-preview"><span>Vorschau · Kennzeichen a</span><strong>{formatInvoiceNumber(form, 23, new Date().getFullYear(), 'a')}</strong></div>
